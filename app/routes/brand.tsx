...
const statusColors: Record<CollabStatus, { bg: string; text: string }> = {
  potential: { bg: "rgba(0,0,0,0.04)", text: "#86868b" },
        ...
        <div>
          ...
          {showAddCollab && (
            <div className="fixed inset-0 z-50 flex items-center justify-center">
              <div className="absolute inset-0 bg-black/20" onClick={() => setShowAddCollab(false)} />
              <div className="relative w-full max-w-md card-static p-6">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <button onClick={() => setShowAddCollab(false)} className="p-1 hover:bg-[rgba(0,0,0,0.04)] rounded">
