...
const featureStatusConfig: Record<FeatureStatus, { label: string; bg: string; text: string }> = {
  backlog: { label: "Backlog", bg: "rgba(0,0,0,0.04)", text: "#86868b" },
    ...
    <div className="space-y-6">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                activeTab === tab.key ? "bg-[rgba(0,0,0,0.04)] text-[#1d1d1f]" : "text-[#aeaeb2] hover:text-[#1d1d1f]"
              )}
            >
      ...
      {showLogRevenue && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0 bg-black/20" onClick={() => setShowLogRevenue(false)} />
          <div className="relative w-full max-w-md card-static p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <button onClick={() => setShowLogRevenue(false)} className="p-1 hover:bg-[rgba(0,0,0,0.04)] rounded">
      ...
      {showAddFeature && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0 bg-black/20" onClick={() => setShowAddFeature(false)} />
          <div className="relative w-full max-w-md card-static p-6">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-[16px] font-medium text-[#1d1d1f]">New SkyWay Feature</h2>
              <button onClick={() => setShowAddFeature(false)} className="p-1 hover:bg-[rgba(0,0,0,0.04)] rounded">
                <X className="w-4 h-4 text-[#aeaeb2]" />
              </button>
            </div>
      ...
      {showLogIncome && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0 bg-black/20" onClick={() => setShowLogIncome(false)} />
          <div className="relative w-full max-w-md card-static p-6">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-[16px] font-medium text-[#1d1d1f]">Log Monthly Income</h2>
              <button onClick={() => setShowLogIncome(false)} className="p-1 hover:bg-[rgba(0,0,0,0.04)] rounded">
                <X className="w-4 h-4 text-[#aeaeb2]" />
              </button>
            </div>
