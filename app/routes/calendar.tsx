        ...
        <div className="flex rounded-[10px] bg-[rgba(0,0,0,0.03)] p-1">
          <button
            ...
            className={cn(
              ...
              view === "month" ? "bg-[rgba(0,0,0,0.04)] text-[#1d1d1f]" : "text-[#aeaeb2] hover:text-[#1d1d1f]"
            )}
          >
            Month
          </button>
          <button
            ...
            className={cn(
              "px-4 py-1.5 text-[13px] font-medium rounded-lg transition-colors",
              view === "week" ? "bg-[rgba(0,0,0,0.04)] text-[#1d1d1f]" : "text-[#aeaeb2] hover:text-[#1d1d1f]"
            )}
          >
            Week
          </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-md card-static p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <button onClick={() => setShowCreate(false)} className="p-1 hover:bg-[rgba(0,0,0,0.04)] rounded">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-md card-static p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => setSelectedItem(null)} className="p-1 hover:bg-[rgba(0,0,0,0.04)] rounded">
                <X className="w-4 h-4 text-[#aeaeb2]" />
              </button>
            </div>
